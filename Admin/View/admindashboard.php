...
require_once "../Controller/adminconntroller.php";
...
<head>
  ...
  <link rel="stylesheet" href="../public/style4.css?v=<?php echo time(); ?>">
...
<body>
  <header class="main-header">
    <nav class="navbar">
      <div class="nav-logo">
        <h3 class="nav-title"><span>khamar</span>bari - Admin</h3>
      </div>
      <ul class="nav-links">
